...
//************* Proyecto Final de Laboraotrio de Computación Gráfica	*****************//
//************************************************************//
...
void mesa_lab()
{
	f_silla.prisma(3.0, 0.15, 1.5, mesa.GLindex);
	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			//EJE DE REFERENCIA
				...
				f_base.prisma(24.0,1.0,10.0,pasto.GLindex);		//Base
				glPushMatrix();
					glTranslatef(-15.0,0.0,-2.0);			//Base Izq
					f_base.prisma(4.0,1.0,7.0, pasto.GLindex);
				glPopMatrix();
				 
				glPushMatrix();
					glTranslatef(-7.75, 0.0, -15.5);			//Base Izq trasera
					f_base.prisma(9.0, 1.0, 7.0, pasto.GLindex);
				glPopMatrix();
				...
				f_base.prisma(4.0, 1.0, 3.5, pasto.GLindex);
				glPopMatrix();
				...
				f_base.prisma(6.0, 1.0, 5.0, pasto.GLindex);
				glPopMatrix();
				...
				glPushMatrix();
					...
					f_edificio.prisma(10.0,7.0,8.0, concreto.GLindex);			//Planta baja Izq
					glTranslatef(0.0,4.75, 0.0);
					f_edificio.prisma(10.0, 4.5, 8.0, concreto.GLindex);		//Primer piso Izq
					glTranslatef(0.0, 3.5, 0.0);
					f_edificio.prisma(10.0, 4.5, 8.0, concreto.GLindex);		//Segundo piso Izq
					glTranslatef(0.0, 3.5, 0.0);
					f_edificio.prisma(10.0, 4.5, 8.0, concreto.GLindex);		//Tercer piso Izq
					glTranslatef(0.0, 4.0, 0.0);
					f_edificio.prisma(10.0, 5.5, 8.0, concreto.GLindex);		//Cuarto piso Izq
				glPopMatrix();

				glPushMatrix();
				glTranslatef(7.0, 3.0, 0.0);
				f_edificio.prisma(10.0, 7.0, 8.0, concreto.GLindex);		//Planta baja Der
				glTranslatef(0.0, 4.75, 0.0);
				f_edificio.prisma(10.0, 4.5, 8.0, concreto.GLindex);		//Primer piso Der
				glTranslatef(0.0, 3.5, 0.0);
				f_edificio.prisma(10.0, 4.5, 8.0, concreto.GLindex);		//Segundo piso Der
				glTranslatef(0.0, 3.5, 0.0);
				f_edificio.prisma(10.0, 4.5, 8.0, concreto.GLindex);		//Tercer piso Der
				glTranslatef(0.0, 4.0, 0.0);
				f_edificio.prisma(10.0, 5.5, 8.0, concreto.GLindex);		//Cuarto piso Der
				glPopMatrix();
